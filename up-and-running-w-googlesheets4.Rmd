...
I'm taking downloaded Excel data on the modern pentathlon, and uploading it to Google Drive as a Google Sheet. From there I want to read some of the data into R, clean it up, and modify the original spreadsheet in Google Drive by adding the tidied version of the data as a new sheet/tab.
